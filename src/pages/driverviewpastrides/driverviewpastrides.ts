...
/**
 * Generated class for the DriverviewpastridesPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-driverviewpastrides',
  templateUrl: 'driverviewpastrides.html',
})
export class DriverviewpastridesPage {
  public userId;
  currentUser: User;
  RideOb;
  RidesArray = [];
